...
int MenuGen()
{
	...
	printf(".1.ALTA GEN1\n");
	printf(".2.BAJA GEN1\n");
	printf(".3.MODIFICACION GEN1\n");
	printf(".4.ALTA GEN2\n");
	printf(".5.BAJA GEN2\n");
	printf(".6.MODIFICACION GEN2\n");
	printf(".7.Listado de productos\n");
	printf(".8.Listado por precio\n");
	printf(".9.Listado por \n");
	printf(".10.Listado por \n");
	printf(".11.Listado por \n");
	printf(".12.Listado por \n");
	printf(".13.SALIR\n");
