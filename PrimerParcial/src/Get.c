...
int MenuGen()
{
	...
	printf("*[BIENVENIDO A LA TIENDA PARCIAL]*\n");
	printf(".1.ALTA BICICLETA TRABAJO\n");
	printf(".2.MODIFICACION TRABAJOS\n");
	printf(".3.BAJA BICICLETA TRABAJO\n");
	printf(".4.listado de todos los trabajos ordenados por año y ante igualdad de año por marca de la bicicleta.\n");
	printf(".5.LISTADO de servicios\n");
	printf(".6.LISTADO total por servicios \n");
	printf(".7.Listado de todos los trabajos ordenados por marca de la bicicleta. \n");
	printf(".8.Listado de servicios con los datos de las bicicletas que se lo realizaron\n");
	printf(".9.LISTADO La cantidad de biciletas de color Rojo que realizaron un servicio-\n");
	printf(".10.LISTADO de entrgas por dia segun marca\n");
	printf(".11.LISTADO de servicio por dia\n");
	printf(".12.SALIR\n");

	opcion=PedirEnteroRango("-Ingrese una opcion del MENU-", "-ERROR, ingrese una opcion valida-", 1, 12);
